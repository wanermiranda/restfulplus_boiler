...
from uploader_api.api.blog.business import create_category, delete_category, update_category
from uploader_api.api.blog.serializers import category, category_with_posts
from uploader_api.api.restplus import api
from uploader_api.database.models import Category
...
class CategoryCollection(Resource):
    ...
    def get(self):
        """
        Returns list of upload intents.
        """
